  ...
  function Card() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Card.__proto__ || Object.getPrototypeOf(Card)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      var _this$props = _this.props,
          ...
          projectOffset = _this$props.projectOffset,
          STARTING_OFFSET = _this$props.STARTING_OFFSET,
      ...
      if (scroll <= showTime) {
        ...
        return "translateY(" + (HEADER_HEIGHT + _this.PROJECT_DESCRIPTION_HEIGHT - staticPos) + "px) scale(1)";
      } else {
        return "translateY(" + (-_this.state.imgHeight - CARD_SHADOW - MOBILE_URL_HEIGHT - staticPos) + "px) " + ("scale(" + (1 - index / total * MAX_SCALE_DOWN_AMOUNT) + ")");
      }
...
var Social = function Social(props) {
  return _react2.default.createElement(
    ...
    [].concat(_toConsumableArray(_social.profile), _toConsumableArray(_social.follow)).map(function (link) {
      return _react2.default.createElement(
        "div",
        {
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement("i", { className: "" + link.icon })
          )
        )
      );
    })
...
var Header = function (_React$Component) {
  ...
  function Header() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Header.__proto__ || Object.getPrototypeOf(Header)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ellipsis: _this.props.forceShow
    }, _this.handleEllipsis = function () {
      _this.setState(function (prevState) {
        return { ellipsis: !prevState.ellipsis };
      });
    }, _temp), _possibleConstructorReturn(_this, _ret);
  }
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          !this.props.forceShow && _react2.default.createElement("i", { className: "fas fa-ellipsis-v", onClick: this.handleEllipsis })
        ),
        _react2.default.createElement(
          "div",
          {
...
var _Projects = __webpack_require__(18);

var _Projects2 = _interopRequireDefault(_Projects);

var _Landing = __webpack_require__(22);

var _Landing2 = _interopRequireDefault(_Landing);

var _End = __webpack_require__(25);
  ...
  _createClass(App, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_Helper2.default, { scroll: scroll })
      );
    }
  }]);
...
var Projects = function (_React$Component) {
  ...
  function Projects() {
    ...
    }, _this.calcImgHeight = function () {
      var MOBILE_WIDTH = 800;
      var DESKTOP_IMAGE_HEIGHT = 400;
      var IMAGE_ASPECT_RATIO = 1.8;
      var width = _this.state.innerWidth;
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          "div",
          null,
          _projects.developments.map(function (item, index) {
...
var _ProjectDetails = __webpack_require__(21);
...
var Project = function (_React$Component) {
  ...
  _createClass(Project, [{
    ...
    value: function render() {
      ...
      var projectOffset = FINAL_OFFSET * index / total;
      var staticPos = innerHeight - STARTING_OFFSET - projectOffset;
      var pcOffset = (projectOffset + STARTING_OFFSET) / (document.body.clientHeight - window.innerHeight);
      return _react2.default.createElement(
        "div",
        null,
...
var ProjectDetails = function (_React$Component) {
  ...
  function ProjectDetails() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = ProjectDetails.__proto__ || Object.getPrototypeOf(ProjectDetails)).call.apply(_ref, [this].concat(args))), _this), _this.calcOpacity = function (scroll, showTime, pcOffset, showEnd) {
      var showPeak = (showEnd + showTime) / 2 - pcOffset;
      if (scroll < showPeak) {
    ...
    }, _this.selectIcon = function (name) {
      switch (name) {
        case "Source":
...
var _Descriptions = __webpack_require__(24);
...
var synonyms = ["making", "building", "creating", "designing", "dreaming of"];
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              " ",
              _react2.default.createElement(_Descriptions2.default, { descriptions: synonyms }),
              " things."
            ),
            _react2.default.createElement(_Social2.default, null),
            _react2.default.createElement(
              "h2",
              { className: "landing-statement", onClick: this.handleCuriosity },
              _react2.default.createElement("i", { className: "fas fa-seedling" }),
              " things below."
            )
          )
        )
...
var DESCRIPTION_ROTATE_INTERVAL_MS = 2000;
...
var Descriptions = function (_React$Component) {
  ...
  function Descriptions() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Descriptions.__proto__ || Object.getPrototypeOf(Descriptions)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      description: "",
      index: 0
  ...
  _createClass(Descriptions, [{
    ...
    value: function componentDidMount() {
      ...
      this.interval = setInterval(this.handleDescription, DESCRIPTION_ROTATE_INTERVAL_MS);
    }
  }, {
    key: "componentWillMount",
    value: function componentWillMount() {
...
var End = function (_React$Component) {
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(_Header2.default, { forceShow: true }),
          _react2.default.createElement(
            "h1",
            { className: "end-statement" },
            "Made with",
            " ",
            _react2.default.createElement(
              "div",
              { className: "heart heart-end" },
              _react2.default.createElement(
                "i",
                { className: "fas fa-heart" },
                _react2.default.createElement(
          ...
          _react2.default.createElement(
            "a",
            { className: "end-button", href: "mailto:samxie.net@gmail.com" },
            "Contact"
          )
        ),
        _react2.default.createElement(
          ...
          _react2.default.createElement("i", { className: "fas fa-file-code" })
        )
      );
    }
  }]);
...
var Helper = function (_React$Component) {
  ...
  function Helper() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Helper.__proto__ || Object.getPrototypeOf(Helper)).call.apply(_ref, [this].concat(args))), _this), _this.handleClick = function () {
  ...
  _createClass(Helper, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        "div",
        { className: "helper" },
        _react2.default.createElement("div", { className: "helper-bar", onClick: this.handleClick })
      );
    }
  }]);
